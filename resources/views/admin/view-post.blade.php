                        ...
                        <div class="card">
                            <div class="card-header border-bottom">
                                <div class="row">
                                    <div
                                        ...
                                        <h6 class="text-primary" style="font-size: 16px">All Posts </h6>
                                    </div>
                                    <div
                                        class="col-md-8 d-flex justify-content-md-end justify-content-center align-items-center">
                                        <div class="d-flex justify-content-end align-items-center" id="post-table-action">
                                            ...
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a href="{{ route('admin.addPostSave') }}" data-bs-toggle="tooltip"
                                                ...
                                                <button type="button" class="btn btn-danger disabled-btn"
                                                    ...
                                                    disabled
                                                    onclick="deleteConfirm('post-delete-all','posts', 'false','','')"><i
                                                        class="fa-regular fa-trash"></i>
                                                    <input type="hidden" value="" id="post-delete-all">
                                                </button>
                                            </div>
                            ...
                            <div class="card-body p-0">
                                <div class="mt-2 mx-2 mb-3">
                                    <table id="post-table" class="table table-hover table-borderless w-100 border-bottom"
                                        style="min-width: 500px">
                                        <thead class="bg-light border-0">
                                            <tr>
                                                <th></th>
                                                <th class="sort text-nowrap">User Name</th>
    ...
    @push('scripts')
        <script>
            ...
            initServerSideDataTable(
                "post-table",
                "/admin/post-datatable-data",
                "post-selected",
                createColumn(postColumn),
                "post-table-action"
            );
        </script>
    @endpush
