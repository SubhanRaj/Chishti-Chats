                                         ...
                                         <div class="d-flex justify-content-end align-items-center"
                                             ...
                                             <div class="btn-group" role="group" aria-label="Basic example">
                                                 ...
                                                 <button type="button" class="btn btn-danger disabled-btn"
                                                     ...
                                                     onclick="deleteConfirm('comment-delete-all','comments', 'false','','')"><i
                                                         class="fa-regular fa-trash"></i>
                                                     <input type="hidden" value="" id="comment-delete-all">
                                                 </button>
                                             </div>
                                 ...
                                 <div class="mt-2 mx-2 mb-3">
                                     <table id="comment-table"
                                         ...
                                         <thead class="bg-light border-0">
                                             <tr>
                                                 <th></th>
                                                 <th class="sort white-space-nowrap">Blog</th>
                                                 <th class="sort white-space-nowrap">Full Name</th>
                                                 <th class="sort white-space-nowrap">Email</th>
                                                 <th class="sort white-space-nowrap">Comment</th>
                                                 <th class="sort white-space-nowrap">Status</th>
                                                 <th class="sort white-space-nowrap">Created At</th>
                                                 <th class="sort white-space-nowrap">Updated At</th>
                                                 <th class="sort white-space-nowrap">Action</th>
                                             </tr>
                                         </thead>
                                         <tbody>
