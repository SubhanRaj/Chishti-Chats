                ...
                <div class="card mb-0">
                    <div class="card-body">
                        ...
                        <div class="mb-3 text-center">
                            <img src="{{ asset('assets/img/logo/logo-full.png') }}" alt=""style="max-width:180px" />
                        </div> 
                        <div class="text-center mb-4">
                            <h5 class="mb-0">Please log in to your account</h5>
                        </div>
                        <div class="form-body">
                            <form class="row g-3" id="form1" onsubmit="uploadData1('form1', '{{ route('login-check') }}', 'alert-box1', 'btn-box1', event)" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col-12 text-center"> <a href="{{ route('showPasswordResetPage') }}">Forgot
                                        Password ?</a>
                                </div>
                                <div class="col-12">
                    ...
                    <div class="p-4">
                        <div class="mb-3 text-center">
                            <img src="{{ asset('admin-assets/assets/images/logo-icon.png') }}" width="60" alt="" />
                        </div>
                        ...
                        <form method="POST" action="{{ route('login-otp-verification') }}">
                            ...
                            <div class="mb-3 d-flex justify-content-center align-items-center">
                                <button class="btn btn-primary d-block w-50 m-2" type="submit" name="submit">Log in
                                </button>
                                <button class="btn btn-danger d-block w-50 m-2" type="button" onclick="reset_login_form()">Cancel
                                </button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="col-12 d-flex justify-content-center align-items-center">
                        <div>
                            <div class="d-flex justify-content-center align-items-center">
                                <img src="{{ asset('admin-assets/assets/images/gif/spiner.svg') }}" height="100p">
                            </div>
