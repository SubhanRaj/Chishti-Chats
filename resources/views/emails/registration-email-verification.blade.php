                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" bgcolor="#ffffff"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Hey <b>{{ $name }}</b>,<br>Thanks for
                                                                        registering with us!</p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px">
                                                                        To activate your account, we need to make sure
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <span class="msohide es-button-border"
                                                                        style="border-style:solid;border-color:#ec6d64;background:#ec6d64;border-width:1px;display:inline-block;border-radius:2px;width:auto;mso-hide:all"><a
                                                                            href="{{ route('frontend.emailVerification', $token) }}"
                                                                            class="es-button es-button-1621839948986"
                                                                            target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;padding:15px 25px;display:inline-block;background:#ec6d64;border-radius:2px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center;mso-padding-alt:0;mso-border-alt:10px solid #ec6d64">Click
                                                                            here to verify your
                                                                            email</a></span>
