        ...
        <div class="container">
            <div class="row align-items-center gy-lg-0 gy-4">
                ...
                <div class="col-lg-4 text-lg-end text-center wow fadeInLeft" data-wow-delay="0.3s">
                    <button type="button" class="action_btn btn_bg round-btn" onclick="show_modal('register-modal')">Get Started Now</button>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Show Recent
                        Categories</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Show Recent
                        Posts</button>
                </li>
            </ul>
        ...
        <div class="container">
            <div class="row action-content-wrapper gy-lg-0 gy-4">
                ...
                <div class="col-lg-5 text-lg-end text-center">
                    <button type="button" class="action_btn btn_bg round-btn" onclick="show_modal('register-modal')">
